            ...
            <aside class="main-sidebar">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(3) == "package") ? "active" : null) ?>">
                            <a href="#">
                                <i class="ti-gift"></i> <span><?php echo "Pin" ?></span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a> 
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("backend/pin/pin/form") ?>"> <?php echo "Creat pin" ?> </a></li>
                                <li><a href="<?php echo base_url("backend/pin/pin/") ?>"> <?php echo "Pin List" ?> </a></li>
                            </ul>
                        </li>
