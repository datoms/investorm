...
?>
                        ...
                        <?php } elseif ($deposit->deposit_method=='Pin')  { ?>
                        <table class="table table-bordered">
                            <tr>
                                <th><?php echo display("user_id") ?></th>
                                <td class="text-right"><?php echo $deposit->user_id ?></td>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><?php echo $deposit->pin_code ?></td>
                            </tr>
                            <tr>
                                <th><?php echo display("amount") ?></th>
                                <td class="text-right">$<?php echo $deposit_data['deposit_amount'] - $deposit->fees ?></td>
                            </tr>
                            <tr>
                                <th><?php echo display("fees") ?></th>
                                <td class="text-right">$<?php echo $deposit->fees ?></td>
                            ...
                            <tr>
                                <th>Total</th>
                                <td class="text-right">$<?php echo $deposit_data['deposit_amount'] ?></td>
                            </tr>
                        </table>
                        <?php echo form_open('payment_callback/pin_confirm', 'method="post" '); ?>
                        <input type="hidden" name="pin_code" value="<?php echo $deposit->pin_code ?>">
